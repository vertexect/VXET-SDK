...
import "github.com/VXETChain/VXET-SDK/common"

// VXETMainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main VXET network.
var VXETMainnetBootnodes = []string{
	// VXET Foundation Bootnodes
...
// VXETTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// VXET test network.
var VXETTestnetBootnodes = []string{
	// VXET Test Bootnodes
...
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	case HoleskyGenesisHash:
		net = "holesky"
	case VXETMainnetGenesisHash:
		net = "vxet-mainnet"
	case VXETTestnetGenesisHash:
		net = "vxet-testnet"
	default:
		return ""
	}

	// VXET specific network discovery
	if genesis == VXETMainnetGenesisHash || genesis == VXETTestnetGenesisHash {
		return dnsPrefix + protocol + "." + net + ".vxetdisco.net"
	}
